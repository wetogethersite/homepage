...
const NavBar = () => {
    ...
    const content = <>
        <div className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-900 transition">
            ...
            <Link spy={true} smooth={true} to = "About">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-700 hover:rounded">About</li>
            </Link>
            <Link spy={true} smooth={true} to = "Skills">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-700 hover:rounded">Skills</li>
            </Link>
            <Link spy={true} smooth={true} to = "Projects">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-700 hover:rounded">Projects</li>
            </Link>
            <Link spy={true} smooth={true} to = "Contact">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-700 hover:rounded">Contact</li>
            </Link>         
            </ul>
    </div>
    </>
    return (
        <nav>
            <div className="h-10vh flex justify-between z-50 text-black lg:py-5 px-20 py-4 border-b border-slate-800">
